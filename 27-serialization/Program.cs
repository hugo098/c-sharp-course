...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (TextWriter tw = new StreamWriter(@"C:\Users\ASUS\bowser.xml"))
            {
            ...
            TextReader reader = new StreamReader(@"C:\Users\ASUS\bowser.xml");
            ...
            using (Stream fs = new FileStream(@"C:\Users\ASUS\animals.xml",
            ...
            using (FileStream fs2 = File.OpenRead(@"C:\Users\ASUS\animals.xml"))
            {
